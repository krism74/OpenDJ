...
webui.suntheme.props = {
     ...
     * Button properties.
     *
     * @deprecated See webui.suntheme.widget.props.button
     */
    button: {
     ...
     *
     * @deprecated See webui.suntheme.widget.props.dropDown
     */
    dropDown: {
     ...
     * Field properties.
     *
     * @deprecated See webui.suntheme.widget.props.textField
     */
    field: {
     ...
     *
     * @deprecated See webui.suntheme.widget.props.jumpDropDown
     */
    jumpDropDown: {
     ...
     * Listbox properties.
     *
     * @deprecated See webui.suntheme.widget.props.listbox
     */
    listbox: {
        className: "Lst_sun4",
