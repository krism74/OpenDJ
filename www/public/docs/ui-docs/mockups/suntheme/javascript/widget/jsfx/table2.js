...
dojo.require("webui.suntheme.widget.table2");

/**
 * This function is used to obtain data asynchronously.
 */
webui.suntheme.widget.jsfx.table2 = {
    /**
    ...
    processRefreshEvent: function(props) {
        ...
        new DynaFaces.fireAjaxTransaction(
            ...
            render: props.id,
            replaceElement: webui.suntheme.widget.jsfx.table2.refreshCallback,
            xjson: {
                id: props.id,
                event: "refresh"
            }
    ...
    refreshCallback: function(id, content, closure, xjson) {
        ...
        webui.suntheme.widget.table2.refresh.publishEndEvent(json);
        return true;
    }
}

// Listen for Dojo Widget events.
dojo.event.topic.subscribe(webui.suntheme.widget.table2.refresh.beginEventTopic,
    webui.suntheme.widget.jsfx.table2, "processRefreshEvent");
