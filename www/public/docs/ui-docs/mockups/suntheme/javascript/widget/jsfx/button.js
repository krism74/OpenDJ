...
dojo.require("webui.suntheme.widget.button");

/**
 * This function is used to obtain data asynchronously.
 */
webui.suntheme.widget.jsfx.button = {
    /**
    ...
    processRefreshEvent: function(props) {
        ...
        new DynaFaces.fireAjaxTransaction(
            ...
            render: props.id,
            replaceElement: webui.suntheme.widget.jsfx.button.refreshCallback,
            xjson: {
                id: props.id,
                event: "refresh"
            }
    ...
    refreshCallback: function(id, content, closure, xjson) {
        ...
        webui.suntheme.widget.button.refresh.publishEndEvent(json);
        return true;
    }
}

// Listen for Dojo Widget events.
dojo.event.topic.subscribe(webui.suntheme.widget.button.refresh.beginEventTopic,
    webui.suntheme.widget.jsfx.button, "processRefreshEvent");
