 ...
 dojo.require("webui.suntheme.widget.radioButton");
 
 /**
  * This function is used to obtain data asynchronously.
  */
 webui.suntheme.widget.jsfx.radioButton = {
     /**
     ...
     processRefreshEvent: function(props) {
         ...
         new DynaFaces.fireAjaxTransaction(
             ...
             render: props.id,
             replaceElement: webui.suntheme.widget.jsfx.radioButton.refreshCallback,
             xjson: {
                 id: props.id,
                 event: "refresh"
             }
     ...
     refreshCallback: function(id, content, closure, xjson) {
        ...
        // Publish an event for custom AJAX implementations to listen for.
         webui.suntheme.widget.radioButton.refresh.publishEndEvent(json);
         return true;
    }
 }
 
 // Listen for Dojo Widget events.
 dojo.event.topic.subscribe(webui.suntheme.widget.radioButton.refresh.beginEventTopic,
     webui.suntheme.widget.jsfx.radioButton, "processRefreshEvent");
