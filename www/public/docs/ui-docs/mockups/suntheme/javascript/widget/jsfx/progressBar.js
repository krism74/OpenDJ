...
webui.suntheme.widget.jsfx.progressBar =  {
    ...
    processRefreshEvent: function(props) {
        ...
        new DynaFaces.fireAjaxTransaction(
            ...
            render: props.id,
            replaceElement: webui.suntheme.widget.jsfx.progressBar.refreshCallback,
            xjson: {
                event: "refresh"
            }
        });
    ...
    progressCallback: function(id, content, closure, xjson) {
        ...
        webui.suntheme.widget.progressBar.progress.publishEndEvent(json);
        return true;
    },
...
dojo.event.topic.subscribe(webui.suntheme.widget.progressBar.progress.beginEventTopic,
