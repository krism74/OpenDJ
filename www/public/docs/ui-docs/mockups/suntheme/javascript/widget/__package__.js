...
dojo.requireIf(djConfig.isDebug, "webui.suntheme.widget.alert");
dojo.requireIf(djConfig.isDebug, "webui.suntheme.widget.button");
dojo.requireIf(djConfig.isDebug, "webui.suntheme.widget.checkbox");
dojo.requireIf(djConfig.isDebug, "webui.suntheme.widget.dropDown");
dojo.requireIf(djConfig.isDebug, "webui.suntheme.widget.hiddenField");
dojo.requireIf(djConfig.isDebug, "webui.suntheme.widget.image");
dojo.requireIf(djConfig.isDebug, "webui.suntheme.widget.label");
dojo.requireIf(djConfig.isDebug, "webui.suntheme.widget.progressBar");
dojo.requireIf(djConfig.isDebug, "webui.suntheme.widget.radioButton");
dojo.requireIf(djConfig.isDebug, "webui.suntheme.widget.staticText");
...
dojo.requireIf(djConfig.isDebug, "webui.suntheme.widget.textField");
