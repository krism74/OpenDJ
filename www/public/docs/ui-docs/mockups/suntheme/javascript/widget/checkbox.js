 ...
 * webui.suntheme.widget.checkbox.setProps for a list of supported
 * properties.
 *
 * Note: This is considered a private API, do not use.
 */
webui.suntheme.widget.checkbox = function() {
    // Set defaults.
    ...
    this.fillInTemplate = function() {
        ...
        this.getClassName = webui.suntheme.widget.checkbox.getClassName;
        this.setProps = webui.suntheme.widget.checkbox.setProps;
        this.getProps = webui.suntheme.widget.checkbox.getProps;
        this.getInputElement = webui.suntheme.widget.checkbox.getInputElement;
        this.refresh = webui.suntheme.widget.checkbox.refresh.processEvent;        
 ...
 */
webui.suntheme.widget.checkbox.getClassName = function() {
    // Set style for the outermost span element.
    var className = webui.suntheme.widget.props.checkbox.spanClassName; 
    if (this.disabled == true) {
        className = webui.suntheme.widget.props.checkbox.spanDisabledClassName;
    }
 ...
 */
webui.suntheme.widget.checkbox.getInputElement = function() {
 ...
 * properties.
 */
webui.suntheme.widget.checkbox.getProps = function() {
    var props = {};
 ...
 */
webui.suntheme.widget.checkbox.refresh = {
    /**
     * Event topics for custom AJAX implementations to listen for.
     */
    beginEventTopic: "webui_suntheme_widget_checkbox_refresh_begin",
    endEventTopic: "webui_suntheme_widget_checkbox_refresh_end",
    ...
    processEvent: function(execute) {
        // Publish event.
        webui.suntheme.widget.checkbox.refresh.publishBeginEvent({
            id: this.id,
            execute: execute
        });
        return true;
    ...
    publishBeginEvent: function(props) {
        dojo.event.topic.publish(webui.suntheme.widget.checkbox.refresh.beginEventTopic, props);
        return true;
    },
    ...
    publishEndEvent: function(props) {
        dojo.event.topic.publish(webui.suntheme.widget.checkbox.refresh.endEventTopic, props);
        return true;
    }
}
 ...
 */
webui.suntheme.widget.checkbox.setProps = function(props) {
    ...
    webui.suntheme.widget.common.setCommonProps(this.checkboxNode, props);
    webui.suntheme.widget.common.setJavaScriptProps(this.checkboxNode, props); 
    ...
    if (props.image || props.disabled != null && this.image) {
        ...
        props.image.className = (props.disabled == true) 
            ? webui.suntheme.widget.props.checkbox.imageDisabledClassName
            : webui.suntheme.widget.props.checkbox.imageClassName;        
    ...
    if (props.label || props.disabled != null && this.label) {
        ...
        props.label.className = (props.disabled == true)
            ? webui.suntheme.widget.props.checkbox.labelDisabledClassName
            : webui.suntheme.widget.props.checkbox.labelClassName;        
...
dojo.inherits(webui.suntheme.widget.checkbox, dojo.widget.HtmlWidget);
