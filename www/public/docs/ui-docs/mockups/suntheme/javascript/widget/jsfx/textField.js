...
dojo.require("webui.suntheme.widget.textField");
...
webui.suntheme.widget.jsfx.textField = {
    ...
    validationCallback: function(elementId, content, closure, xjson) {
        ...
        webui.suntheme.widget.textField.validation.publishEndEvent(json);
        return true;
    },
    ...
    processRefreshEvent: function(props) {
        ...
        new DynaFaces.fireAjaxTransaction(
            ...
            render: props.id,
            replaceElement: webui.suntheme.widget.jsfx.textField.refreshCallback,
            xjson: {
                id: props.id,
                event: "refresh"
            }
    ...
    refreshCallback: function(id, content, closure, xjson) {
        ...
        webui.suntheme.widget.textField.refresh.publishEndEvent(json);
        return true;
    }
}

// Listen for Dojo Widget events.
dojo.event.topic.subscribe(webui.suntheme.widget.textField.validation.beginEventTopic,
