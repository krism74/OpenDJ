...
webui.suntheme.widget.button = function() {
    ...
    this.fillInTemplate = function() {
        ...
        this.getClassName = webui.suntheme.widget.button.getClassName;
        this.getHoverClassName = webui.suntheme.widget.button.getHoverClassName;
        this.getProps = webui.suntheme.widget.button.getProps;
        this.initClassNames = webui.suntheme.widget.button.initClassNames;
        this.refresh = webui.suntheme.widget.button.refresh.processEvent;
        this.setProps = webui.suntheme.widget.button.setProps;
 ...
 */
webui.suntheme.widget.button.getHoverClassName = function() {
    var className = null;
    if (this.mini == true && this.primary == true) {
 ...
 * Helper function to obtain widget (mouse hover) class names.
 */
webui.suntheme.widget.button.initClassNames = function() {
    // Set style classes
    if (this.src != null) {
        this.primaryClassName = webui.suntheme.widget.props.button.imageClassName;
        this.primaryDisabledClassName = webui.suntheme.widget.props.button.imageDisabledClassName;
        this.primaryHovClassName = webui.suntheme.widget.props.button.imageHovClassName;
        ...
        this.primaryClassName = webui.suntheme.widget.props.button.primaryClassName;
        this.primaryDisabledClassName = webui.suntheme.widget.props.button.primaryDisabledClassName;
        this.primaryHovClassName = webui.suntheme.widget.props.button.primaryHovClassName;
        this.primaryMiniClassName = webui.suntheme.widget.props.button.primaryMiniClassName;
        this.primaryMiniDisabledClassName = webui.suntheme.widget.props.button.primaryMiniDisabledClassName;
        this.primaryMiniHovClassName = webui.suntheme.widget.props.button.primaryMiniHovClassName;
        this.secondaryClassName = webui.suntheme.widget.props.button.secondaryClassName;
        this.secondaryDisabledClassName = webui.suntheme.widget.props.button.secondaryDisabledClassName;
        this.secondaryHovClassName = webui.suntheme.widget.props.button.secondaryHovClassName;
        this.secondaryMiniClassName = webui.suntheme.widget.props.button.secondaryMiniClassName;
        this.secondaryMiniDisabledClassName = webui.suntheme.widget.props.button.secondaryMiniDisabledClassName;
        this.secondaryMiniHovClassName = webui.suntheme.widget.props.button.secondaryMiniHovClassName;
    }
}
 ...
 * properties.
 */
webui.suntheme.widget.button.getProps = function() {
    var props = {};
 ...
 */
webui.suntheme.widget.button.refresh = {
    /**
     * Event topics for custom AJAX implementations to listen for.
     */
    beginEventTopic: "webui_suntheme_widget_button_refresh_begin",
    endEventTopic: "webui_suntheme_widget_button_refresh_end",
    ...
    processEvent: function(execute) {
        // Publish event.
        webui.suntheme.widget.button.refresh.publishBeginEvent({
            id: this.id,
            execute: execute
        });
        return true;
    ...
    publishBeginEvent: function(props) {
        dojo.event.topic.publish(webui.suntheme.widget.button.refresh.beginEventTopic, props);
        return true;
    },
    ...
    publishEndEvent: function(props) {
        dojo.event.topic.publish(webui.suntheme.widget.button.refresh.endEventTopic, props);
        return true;
    }
}
