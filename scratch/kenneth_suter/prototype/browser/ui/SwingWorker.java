...
public abstract class SwingWorker<V> implements Future<V>, Runnable {
    ...
    private static final Executor EXECUTOR = new Executor() {
        public void execute(Runnable command) {
          ...
          if (command instanceof SwingWorker) {
            ((SwingWorker)command).thread = t;
          }
          t.start();
        }
    };
    ...
    public void setPriority(int priority) {
      if (this.thread != null) {
        // TODO: throws NPE, need thread group I think
     ...
     * @throws java.util.concurrent.RejectedExecutionException if the executor balks
     */
